...
public class DataModel extends AbstractMessagePart {
    ...
    public Map<String, Structure> structures_by_id;
    @JsonIgnore
    public Map<String, Structure> structures_by_name;
    @JsonIgnore
    Date last_connection;

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static class Devices extends AbstractMessagePart implements DataModelElement {
        public Map<String, Thermostat> thermostats_by_id;
        @JsonIgnore
        public Map<String, Thermostat> thermostats_by_name;
        public Map<String, SmokeCOAlarm> smoke_co_alarms_by_id;
        @JsonIgnore
        public Map<String, SmokeCOAlarm> smoke_co_alarms_by_name;
        public Map<String, Camera> cameras_by_id;
        @JsonIgnore
        public Map<String, Camera> cameras_by_name;
