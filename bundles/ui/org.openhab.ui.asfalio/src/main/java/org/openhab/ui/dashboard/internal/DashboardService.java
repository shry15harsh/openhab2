 ...
 */
package org.openhab.ui.asfalio.internal;
...
import org.openhab.ui.asfalio.DashboardTile;
...
public class DashboardService {
    ...
    public static final String DASHBOARD_ALIAS = "/asfalio";

    /** the name of the servlet to be used in the URL */
    public static final String SERVLET_NAME = "myindex";
    ...
    protected void activate(ComponentContext componentContext) {
        try {
            ...
            logger.info("Started asfalio dashboard at " + DASHBOARD_ALIAS);
    ...
    protected void deactivate(ComponentContext componentContext) {
        ...
        logger.info("Stopped asfalio dashboard");
    }
